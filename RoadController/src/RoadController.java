...
public class RoadController
{
    ...
    public static void main(String[] args)//создаётся массив строчек args
    {
     ...
     */
    private static int calculatePrice(Car car)//создаётся объект car класса Car передаваемый при вызове метода
    {
     ...
     */
    private static void blockWay(String reason)//создаётся строка reason передаваемая при вызове метода
    {
